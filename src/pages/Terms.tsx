...
const Terms = () => {
  return (
    <div className='flex flex-col justify-between xl:col-start-4 xl:col-span-6 gap-8'>
      <Back />
        ...
        <div className='flex flex-col justify-center text-center'>
          ...
          <div className='text-left flex flex-col mb-8'>
            ...
            <ul className='list-disc ml-10 mb-2 leading-relaxed'>
              ...
              <li>
                Keep in mind prices may change due to character complexity, background, accessories
                etc.
              </li>
              <li>
                I can charge extra for lack of proper reference e.g. you only send sketches without
                colors.
              </li>
              <li className='font-semibold'>I can only receive payment via PayPal or Ko-Fi!</li>
              <li>
                <span className='font-semibold'>My prices are in USD! </span>You can send it either
                that way or let PayPal convert it to HUF or EUR.
              </li>
              <li>
                When making a payment please write your username in the payment's textbox so I know
                who is the sender!
              </li>
            </ul>
          </div>
          ...
          <div className='text-left flex flex-col mb-8'>
            ...
            <ul className='list-disc ml-10 mb-2 leading-relaxed'>
              <li>
                I provide <span className='font-semibold'>2-3 WIP sketches</span> about the concept
                so you can ask for changes during the sketch part
              </li>
              <li>
                After the sketch is done, changes are limited. Keep in mind you have{' '}
                <span className='font-semibold'>3 free changes</span> (extra changes come with extra
                charges). After the lineart is done you can not ask big changes, e.g. another pose
                or drastic changes like a new face expression.
              </li>
              <li>
      ...
      <Block title='THE COMISSION PROCESS'>
      </Block>
    </div>
  );
};
